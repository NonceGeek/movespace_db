defmodule ChatProgrammingWeb.ChatGPTLive do
    alias ChatProgrammingWeb.Message
    alias ChatProgrammingWeb.LoadingIndicatorComponent
    alias ChatProgrammingWeb.AlertComponent
    ...
    def mount(
      ...
      {:ok,
       ...
       |> assign(%{
         ...
         scenario: scenario,
         mode: :scenario,
         messages: [%ChatProgrammingWeb.Message{content: scenario.description, sender: :assistant, id: 0}]
       })}
    end
    ...
    def render(assigns) do
      ...
      <.container class="mt-10">
        <div id="chatgpt" class="flex" style="height: calc(100vh - 64px); flex-direction: column;">
            ...
            <div>
            <.live_component
                module={ChatProgrammingWeb.MessageListComponent}
            ...
            <.live_component
                ...
                module={ChatProgrammingWeb.TextboxComponent}
                disabled={@loading}
                id="textbox"
            />
            </div>
